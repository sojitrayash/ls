<nav>
        ...
        <li class="<?php if($page=='country') {echo 'active';} ?>"><a href="country.php"><i class="fa fa-flag"></i> <span>Country Section</span></a></li>

        <li class="<?php if($page=='state') {echo 'active';} ?>"><a href="state.php"><i class="fa fa-flag"></i> <span>State Section</span></a></li>
